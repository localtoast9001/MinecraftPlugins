...
public class RootCommandExecutor implements CommandExecutor {
    ...
    /**
     * Gets the collection of player command processors to register.
     * @return the player command processors.
     */
    public final Collection<PlayerCommandProcessor>
        getPlayerCommandProcessors() {
        return this.playerCommandProcessors;
    }

    /**
     * Gets the collection of console command processors to register.
     * @return the player command processors.
     */
    public final Collection<ConsoleCommandProcessor>
        getConsoleCommandProcessors() {
        return this.consoleCommandProcessors;
    }
    ...
    public final boolean onCommand(
        ...
        if (sender instanceof Player) {
            ...
            if (!player.hasPermission("StrategyCraft." + label)) {
